      ...
      return (
        <div className={loginContainerClass}>
          ...
          <h1 className="login-heading">
            All you need is internet in order to chat with other users
          </h1>
          ...
          <div className={termsClass}>
            ...
            <p>
              However, we strongly recommend that you register with an email and password that you
              do not use for any other service.
            </p>
            <p>
              Please note that your account information cannot be reset if you forget your email or
              password.
            </p>
