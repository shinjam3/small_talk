			...
			<div className='group-container'>	
				<div className='group-nav'>
					<div className='group-nav-left-container'>
						<div className='group-nav-back' onClick={goBack}>&#10094;</div>
						<h1 className='group-nav-h1'>{groupMembersNames.join(', ')}</h1>
						<div className='group-nav-add' onClick={showAddMember}>&#65291;</div>
					</div>
					<div className='group-nav-settings-button' onClick={selectSettings}>⚙️</div>
				</div>
				...
				<div className='group-footer'>
					...
					<button className='group-send-button' onClick={messageSent}>Send</button>
				</div>
			</div>
