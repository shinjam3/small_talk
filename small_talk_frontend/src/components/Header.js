    ...
    <div>
      <div className={headerContainerClass}>
        ...
        <nav className="header-nav-container">
          <NavLink className="header-nav-link" exact to="/dashboard/messages">
            Messages
          </NavLink>
          <NavLink className="header-nav-link" exact to="/dashboard/connect">
            Connect
          </NavLink>
          <NavLink className="header-nav-link" exact to="/dashboard/friends">
            Friends
          </NavLink>
        </nav>
